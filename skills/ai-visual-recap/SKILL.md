...
description: >-
  ...
  notes. Trigger for "recap this PR", "summarize the change for review", "show
  me what this branch changed". In ai-engineering it runs when CLOSING a
  milestone (step 12), not on demand; the artifact lives at
  .ai-engineering/recap.html. Not for judging whether the work is any good —
  use /ai-verify.
license: Apache-2.0
---
...
When ai-visual-recap is invoked in a chat thread after work has already happened,
...
These are parts of the upstream Agent-Native Plans collection, not installed
skills; consult them only where that collection is present:
...
1. Canonical name: ai-visual-recap.
