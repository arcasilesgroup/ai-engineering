...
- `.agents/skills/plan/SKILL.md` -- classification, discovery, risk
- `.agents/skills/brainstorm/SKILL.md` -- divergent exploration before convergence
- `.agents/skills/spec/SKILL.md` -- branch creation and spec scaffolding
- `.agents/skills/governance/SKILL.md` -- governance validation, risk acceptance
