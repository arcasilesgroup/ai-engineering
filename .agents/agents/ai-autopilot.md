...
model: opus
mirror_family: antigravity-agents
...
> See dispatch threshold in skill body (`.agents/skills/ai-autopilot/SKILL.md`). The procedural contract for the 6 phases (DECOMPOSE, DEEP PLAN, ORCHESTRATE, IMPLEMENT, QUALITY LOOP, DELIVER) is canonical there; this agent file is the dispatch handle, not a redefinition.
...
| `.agents/skills/ai-pr/SKILL.md` | 6 | Full PR pipeline (all steps), watch-and-fix loop |
| `.agents/skills/ai-commit/SKILL.md` | 4, 5 | Wave commits, quality-fix commits |
| `.agents/skills/ai-build/SKILL.md` | 4 | Task execution patterns, two-stage review (canonical implementation gateway, D-127-11) |
