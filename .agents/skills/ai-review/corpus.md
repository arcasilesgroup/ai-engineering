...
- "a finding claims a version of a dependency that contradicts what is installed" — refused: the installed version decides, and a contradicting claim is dropped or marked `unverified`, never trusted from memory.
