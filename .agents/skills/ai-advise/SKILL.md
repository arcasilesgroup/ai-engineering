...
**Calls**: the `ai-advise` agent (`.agents/agents/ai-advise.md`) via the Agent
tool. Never reads or executes the agent body inline — strictly dispatch.

**See also**:
- `.agents/skills/ai-verify/SKILL.md` — evidence-backed BLOCK lane (different engine).
- `.agents/skills/ai-review/SKILL.md` — narrative human-judgment review.
