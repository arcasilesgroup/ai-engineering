...
- [ ] File created at correct path (.agents/skills/ai-{name}/SKILL.md or .agents/agents/ai-{name}.md)
...
Look at existing skills like .agents/skills/ai-security/SKILL.md or .agents/skills/ai-review/SKILL.md
