...
- `.agents/skills/ai-verify/SKILL.md` -- IRRV protocol, 7 scan modes,
  scan output contract
- `.agents/skills/ai-review/SKILL.md` -- 8-agent parallel review,
...
- Read `.agents/skills/ai-verify/SKILL.md` at dispatch time.
...
- Read `.agents/skills/ai-review/SKILL.md` at dispatch time.
