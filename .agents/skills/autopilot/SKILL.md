...
- `.agents/skills/verify/SKILL.md` for quality gates (Phase 5)
- `.agents/skills/review/SKILL.md` for code review (Phase 5)
- `.agents/skills/pr/SKILL.md` for pull request creation and delivery (Phase 6)
- `.agents/skills/commit/SKILL.md` for incremental commit protocol (Phase 4, 5)
