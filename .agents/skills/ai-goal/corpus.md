...
Runs the whole governed cycle in one pass and stops only to hand a person a tested,
runnable thing to try like a client. The invocation is the standing approval; the person
returns at the end, not in the middle.

## Routes here

- "finish this without me, give me something to test" — the whole cycle, one run, then a handover.
...
- "just write the spec" — use `/ai-spec`; a single stage costs less than the other nine wrapped around it.
- "drop the council, it always agrees" — refused: separate readers find what the writer cannot, and dropping a stage is what this exists to prevent.
- "approve it yourself and keep going" — the invocation is the approval; never claim a green you did not earn.
