...
Dispatch the `ai-onboard` agent for any human-onboarding, archaeology, or codebase-tour request. Strictly read-only. The agent file (`.agents/agents/ai-onboard.md`) is the dispatch handle; mode procedures and pedagogical principles live here.
