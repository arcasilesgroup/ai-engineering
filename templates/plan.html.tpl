...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  table { width:100%; border-collapse:collapse; margin:var(--s4) 0; }
  td, th { padding:10px var(--s4); border-bottom:1px solid var(--line); color:var(--dim); font-size:var(--fs-small); text-align:left; vertical-align:top; }
  th { font-family:var(--mono); font-size:var(--fs-label); text-transform:uppercase; letter-spacing:.12em; color:var(--accent); border-bottom:1px solid var(--line-strong); }
  td:first-child { font-family:var(--mono); color:var(--accent); }
  code { font-family:var(--mono); font-size:var(--fs-mono); background:var(--surface-2); border:1px solid var(--line); border-radius:5px; padding:1px 6px; color:var(--accent-dim); }
  a { color:var(--accent); }
