...
- **Build Context Output Contract** -- the Findings / Dependencies / Risks / Recommendations block produced by `ai-build`, plus the deliverable hand-off shape: file paths produced, test-runner entry points, runnable scenario hooks. See `.codex/agents/ai-build.md` Context Output Contract.
