...
- `.codex/skills/ai-plan/SKILL.md` -- classification, discovery, risk
- `.codex/skills/ai-brainstorm/SKILL.md` -- divergent exploration, spec creation, branch scaffolding
- `.codex/skills/ai-governance/SKILL.md` -- governance validation, risk acceptance
