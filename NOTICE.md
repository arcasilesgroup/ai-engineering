...
| ai-write | original; `references/voice.md` adapted from i-have-adhd | ai-engineering; voice source supplied in-session (author undeclared) | Apache-2.0; voice MIT | https://github.com/arcasilesgroup/ai-engineering |
