...
### Fixed
- **Windows smoke Python install resilience** — `.github/workflows/ci.yml` now retries `uv python install 3.12` up to 3 times with backoff in `framework-smoke`, reducing transient GitHub network/download failures.
