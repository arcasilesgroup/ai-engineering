...
- `.claude/skills/_shared/execution-kernel.md` -- per-wave per-task loop (Phase 4)
- `.claude/skills/ai-verify/SKILL.md`, `ai-review/SKILL.md`, `ai-governance/SKILL.md` -- quality loop (Phase 5), read once at loop entry
- `.claude/skills/ai-pr/SKILL.md` -- pull request creation (Phase 6)
- `.claude/skills/ai-commit/SKILL.md` -- incremental commit protocol (Phases 4, 5)
