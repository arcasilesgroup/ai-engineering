...
- `.claude/skills/ai-governance/SKILL.md` -- governance validation modes (integrity, compliance, ownership, operational, risk, standards)
- `.claude/agents/ai-guard.md` -- proactive governance advisory and drift detection
- `.claude/agents/ai-verify.md` -- 7-mode assessment agent
