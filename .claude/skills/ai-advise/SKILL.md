...
3. **Dependency preflight** — verify `.claude/agents/ai-guard.md` (or, post-rename, `.claude/agents/ai-advise.md`) is on disk. STOP and report the exact missing path if absent — never paraphrase agent instructions inline.
...
- Agent contract: `.claude/agents/ai-guard.md` (or post-rename `.claude/agents/ai-advise.md`)
- Sibling gates: `.claude/skills/ai-verify/SKILL.md` (evidence-backed BLOCK lane), `.claude/skills/ai-review/SKILL.md` (narrative review)
