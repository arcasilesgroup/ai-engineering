...
- `.claude/skills/ai-pr/SKILL.md` — PR workflow (changelog updates go through PRs).
- `.claude/skills/ai-security/SKILL.md` — security entry format and CVE handling.
- `.claude/skills/ai-migrate/SKILL.md` — breaking changes documentation requirements.
$ARGUMENTS
