...
- `.claude/skills/ai-brainstorm/SKILL.md` -- spec creation and scope definition
- `.claude/skills/ai-dispatch/SKILL.md` -- task dispatch and agent coordination
- `.claude/skills/ai-verify/SKILL.md` -- anti-hallucination gates and quality verification
- `.claude/skills/ai-pr/SKILL.md` -- pull request creation and delivery
- `.claude/skills/ai-commit/SKILL.md` -- incremental commit protocol
