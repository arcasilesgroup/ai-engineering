...
the plural — one capability of nineteen has a caller, and that sentence sat in a note.
...
def test_the_count_of_capabilities_with_a_caller_is_published_and_does_not_drop():
    ...
    One of nineteen today, through `ai-report issue`. That gap is real and this does not
