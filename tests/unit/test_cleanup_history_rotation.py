"""Regression: ``/ai-cleanup`` SKILL.md documents the ``_history.md`` rotation
...
CLEANUP_SKILL_FILES = (
    REPO_ROOT / ".claude" / "skills" / "ai-cleanup" / "SKILL.md",
    REPO_ROOT / ".github" / "skills" / "ai-cleanup" / "SKILL.md",
    REPO_ROOT / ".codex" / "skills" / "ai-cleanup" / "SKILL.md",
    REPO_ROOT / ".gemini" / "skills" / "ai-cleanup" / "SKILL.md",
)
