...
name: ai-integrity
version: 1.0.0
description: "Comprehensive framework self-verification: sync, validate, doctor, governance, drift. Modes: full | quick | sync."
...
- `.github/prompts/ai-governance.prompt.md` -- governance validation modes (integrity, compliance, ownership, operational, risk, standards)
- `.github/agents/guard.agent.md` -- proactive governance advisory and drift detection
- `.github/agents/verify.agent.md` -- 7-mode assessment agent
