...
- `.github/prompts/ai-explain.prompt.md` — diagram templates, complexity patterns, edge case catalog.
- `.github/prompts/ai-quality.prompt.md` — code understanding patterns.
- `.github/prompts/ai-architecture.prompt.md` — architecture context methodology.
- `.github/prompts/ai-debug.prompt.md` — root cause explanation patterns.
- `.github/agents/build.agent.md` — agent that benefits from explanation capability.
- `.github/agents/verify.agent.md` — agent that benefits from architecture explanations.
