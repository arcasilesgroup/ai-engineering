...
Inherits language rules from `.github/prompts/ai-explain.prompt.md`: precise terminology, no filler words, active voice.
...
- `.github/agents/guide.agent.md` -- guide agent that invokes onboard.
- `.github/prompts/ai-explain.prompt.md` -- 3-tier depth model, language rules.
- `.github/agents/guide.agent.md` -- guide agent behavioral contract.
