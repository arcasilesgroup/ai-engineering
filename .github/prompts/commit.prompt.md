---
description: "Stage, commit, and push changes following governance workflow"
mode: "agent"
---
...
Read and execute the skill defined in `.ai-engineering/skills/workflows/commit/SKILL.md`.
