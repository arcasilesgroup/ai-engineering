...
3. **Search specs** -- look in `context/specs/` for relevant specifications.
...
3. **Search specs** -- `context/specs/` for specs that introduced the decision.
...
- `.github/prompts/ai-explain.prompt.md` -- 3-tier depth model.
