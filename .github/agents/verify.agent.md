...
- `.github/prompts/ai-security.prompt.md` -- OWASP SAST + DAST + deps + SBOM
- `.github/prompts/ai-quality.prompt.md` -- coverage + complexity + duplication + review
- `.github/prompts/ai-governance.prompt.md` -- integrity + compliance + ownership
- `.github/prompts/ai-performance.prompt.md` -- performance profiling and bottleneck detection
- `.github/prompts/ai-accessibility.prompt.md` -- WCAG 2.1 AA compliance audit
- `.github/prompts/ai-gap.prompt.md` -- spec vs code gap detection
- `.github/prompts/ai-architecture.prompt.md` -- drift, coupling, cohesion, boundaries
- `.github/prompts/ai-triage.prompt.md` -- create work items for findings
