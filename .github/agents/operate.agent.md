...
Normative shared rules are defined in `.github/prompts/ai-ops.prompt.md` under **Shared Rules (Canonical)** (`OPS-R1..OPS-R5`, `OPS-B1`). The agent references those rules instead of redefining them.
...
- `.github/prompts/ai-ops.prompt.md` -- operational automation (run, incident, status)
