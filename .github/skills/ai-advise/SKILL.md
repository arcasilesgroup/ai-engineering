...
3. **Dependency preflight** — verify `.github/agents/guard.agent.md` (or, post-rename, `.github/agents/advise.agent.md`) is on disk. STOP and report the exact missing path if absent — never paraphrase agent instructions inline.
...
- Agent contract: `.github/agents/guard.agent.md` (or post-rename `.github/agents/advise.agent.md`)
- Sibling gates: `.github/skills/ai-verify/SKILL.md` (evidence-backed BLOCK lane), `.github/skills/ai-review/SKILL.md` (narrative review)
