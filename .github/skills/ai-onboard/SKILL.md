...
Dispatch the `ai-onboard` agent for any human-onboarding, archaeology, or codebase-tour request. Strictly read-only. The agent file (`.github/agents/onboard.agent.md`) is the dispatch handle; mode procedures and pedagogical principles live here.
...
- `.github/skills/ai-explain/SKILL.md` -- 3-tier depth model.
