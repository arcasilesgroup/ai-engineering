...
Read `handlers/phase-implement.md` and execute. **Per-wave kernel**: see `.github/skills/_shared/execution-kernel.md`. Autopilot wraps the kernel per-wave -- dispatch the build agent per sub-spec in parallel within a wave (Sub-flow 1), run the build-verify-review loop per task (Sub-flow 2), collect Self-Reports + per-wave commits (Sub-flow 3), advance board state (Sub-flow 4). Cascade-block dependents of failed sub-specs.
...
- **Reads**: `.github/skills/_shared/execution-kernel.md`, `ai-verify/SKILL.md`, `ai-review/SKILL.md`, `ai-governance/SKILL.md`, `ai-pr/SKILL.md`, `ai-commit/SKILL.md`
