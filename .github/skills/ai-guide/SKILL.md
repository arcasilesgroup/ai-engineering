...
Dispatch the `ai-guide` agent for any human-onboarding, archaeology, or codebase-tour request. Strictly read-only. The agent file (`.github/agents/guide.agent.md`) is the dispatch handle; mode procedures and pedagogical principles live here.
