...
- Count directories in `.gemini/skills/`, `.github/skills/`, `.codex/skills/`, `.gemini/skills/`; same for `.gemini/agents/` etc.
...
For every agent file under `.gemini/agents/`, `.github/agents/`,
