...
**Skill Compatibility**:
- Count directories in `.gemini/skills/`, `.github/skills/`, `.codex/skills/`, `.gemini/skills/`
- Scan all `.gemini/skills/*/SKILL.md` frontmatter for `copilot_compatible: false`
- Read `skills.total` from `.ai-engineering/manifest.yml`
- Expected: `.github/skills/` count = `.gemini/skills/` count − (number of `copilot_compatible: false` skills)

**Agent Distribution**:
- Count files in `.gemini/agents/`, `.github/agents/`, `.codex/agents/`, `.gemini/agents/`
