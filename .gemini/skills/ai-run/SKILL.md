...
**Shared handlers:**
- `.gemini/skills/_shared/execution-kernel.md` -- per-item per-task loop (Step 4)

**Agents:**
- `.gemini/agents/ai-explore.md`
- `.gemini/agents/ai-build.md`

**Skills:**
- `.gemini/skills/ai-review/SKILL.md`
- `.gemini/skills/ai-verify/SKILL.md`
- `.gemini/skills/ai-pr/SKILL.md`
- `.gemini/skills/ai-board-sync/SKILL.md`
- `.gemini/skills/ai-resolve-conflicts/SKILL.md`
...
- **Reads**: `.gemini/skills/_shared/execution-kernel.md`, `references/*` (intake/orchestrate phase contracts)
