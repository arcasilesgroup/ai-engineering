...
Dispatch the `ai-guide` agent for any human-onboarding, archaeology, or codebase-tour request. Strictly read-only. The agent file (`.gemini/agents/ai-guide.md`) is the dispatch handle; mode procedures and pedagogical principles live here.
