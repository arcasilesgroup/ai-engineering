...
```
The skill at .gemini/skills/<name>/SKILL.md was just rewritten based on pain
...
1. List skills from `.gemini/skills/` in priority order: Tier 1 workflow (plan, dispatch, review, verify, commit, pr, code, test), Tier 2 enterprise (security, governance, pipeline, docs, release-gate, debug), Tier 3 meta/teaching (create, learn, explain, guide, instinct), Tier 4 specialized.
