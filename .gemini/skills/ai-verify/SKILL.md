...
- `.gemini/skills/ai-verify/handlers/verify.md`
- `.gemini/agents/internal/verify-deterministic.md`
- every required `.gemini/agents/internal/verifier-*.md` file for the selected mode
