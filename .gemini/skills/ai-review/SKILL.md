...
- `.gemini/skills/ai-review/handlers/review.md`
- `.gemini/agents/internal/review-context-explorer.md`
- `.gemini/agents/internal/review-finding-validator.md`
- every required `.gemini/agents/internal/reviewer-*.md` file for the selected mode and detected diff scope
...
All specialist agents are dispatched via the `Agent` tool from `.gemini/agents/internal/`. They are not read inline -- each runs in its own context window.
