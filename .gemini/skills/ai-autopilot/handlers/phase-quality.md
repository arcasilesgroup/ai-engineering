...
- `.gemini/skills/ai-verify/SKILL.md` -- IRRV protocol, 7 scan modes, scan output contract
- `.gemini/skills/ai-review/SKILL.md` -- 8-agent parallel review, self-challenge protocol, confidence scoring
- `.gemini/skills/ai-governance/SKILL.md` -- advise mode, decision-store lifecycle
...
1. **Skill files**: `.gemini/skills/ai-verify/SKILL.md`, `.gemini/skills/ai-review/SKILL.md`, `.gemini/skills/ai-governance/SKILL.md`
...
After the loop completes (pass or exhausted), write the quality rounds log to `.ai-engineering/runtime/autopilot/manifest.md` under a `## Quality Rounds` section:
