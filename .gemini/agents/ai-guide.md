...
> See dispatch threshold in skill body (`.gemini/skills/ai-guide/SKILL.md`). Mode procedures (`tour`, `find`, `history`, `onboard`) and pedagogical principles are canonical there. This agent file owns context-loading and read-only boundary enforcement.
...
- `.gemini/skills/ai-guide/SKILL.md` -- interactive guidance procedures
