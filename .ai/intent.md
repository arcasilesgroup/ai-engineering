{
  ...
  "solution_intent": {
    "current_facts": [
      "Spec 010 is draft and its P0 implementation is in progress.",
      "The product has a narrow v1 backbone; this Intent and its validator are P0 foundation work.",
      "No P1-P5 phase, URL, deployment, pilot or compliance claim is proven by this record."
    ],
    "fixed_constraints": [
