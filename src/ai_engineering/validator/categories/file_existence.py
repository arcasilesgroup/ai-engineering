...
def _record_spec_buffer_result(report: IntegrityReport, work_plane: ActiveWorkPlane) -> None:
    ...
    spec-132 D-132-09: ``_history.md`` is owned by ``/ai-branch-cleanup`` per
        ...
        if spec_plan_present:
                ...
                report.checks.append(
                    IntegrityCheckResult(
                        ...
                        message=(
                            ...
                            "/ai-branch-cleanup will create it on first lifecycle close."
                        ),
            ...
            report.checks.append(
                IntegrityCheckResult(
                    ...
                    message=(
                        "Optional _history.md missing; /ai-branch-cleanup will create it on "
