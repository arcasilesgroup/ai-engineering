...
BODY_SHA256 = "79704be743ae41428da3f70a7ea9e862301c04290d209a43ae6169d85e543820"
...
def _load_capabilities_payload(state_dir: Path) -> dict:
    """Return the framework-capabilities JSON payload, falling back to defaults.

    When ``framework-capabilities.json`` is absent or unparseable,
    return the JSON-mode dump of a fresh
    :class:`FrameworkCapabilitiesCatalog`. The lazy import avoids
    circular references with ``state.models``.
    """
