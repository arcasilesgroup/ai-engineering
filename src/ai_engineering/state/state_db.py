...
# spec-148 P2/P3: ``decision-store.json`` and ``ownership-map.json`` are
# canonical file SoTs (files-only) — no longer deprecated fallbacks, must
# NOT warn. ``install-state.json`` / ``framework-capabilities.json`` move
# to files in P4 and stay deprecated here until then.
