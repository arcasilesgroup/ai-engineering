"""plan --skip "<reason>" — one design exception, granted by a person.
...
emits an event, and `digest` lists them by name: a guard you bypass three times is a
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser("ai-eng plan")
    parser.add_argument(
