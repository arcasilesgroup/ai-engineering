...
- Never refactor without tests. If tests don't exist, write them first (see `.claude/skills/ai-test/SKILL.md`).
...
- `.claude/skills/ai-test/SKILL.md` — for writing tests before refactoring.
- `.claude/agents/ai-build.md` — agent that uses this skill.
$ARGUMENTS
