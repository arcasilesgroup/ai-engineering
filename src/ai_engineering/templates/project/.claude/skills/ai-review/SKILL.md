...
- `.claude/agents/review-context-explorer.md`
- `.claude/agents/review-finding-validator.md`
- every required `.claude/agents/reviewer-*.md` file for the selected mode and detected diff scope
