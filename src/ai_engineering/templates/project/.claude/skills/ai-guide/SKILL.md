---
name: ai-guide
description: "Activate the ai-guide agent for teaching, onboarding, architecture tours, and decision archaeology."
argument-hint: "teach|tour|why|onboard"
---
...
Uses `.claude/skills/ai-onboard/SKILL.md` for structured codebase onboarding and `.claude/skills/ai-explain/SKILL.md` (shared) for the 3-tier depth model (Quick/Standard/Deep) when delivering explanations. Teaching, architecture tours, and decision archaeology are embedded in this agent definition.
...
Deliver deep explanation of a concept, pattern, or architectural decision using the 3-tier depth model from `.claude/skills/ai-explain/SKILL.md`.
...
Structured codebase onboarding via `.claude/skills/ai-onboard/SKILL.md`.
...
- `.claude/skills/ai-onboard/SKILL.md` -- structured codebase onboarding
- `.claude/skills/ai-explain/SKILL.md` -- shared: 3-tier depth model, explanation delivery, diagram rules
