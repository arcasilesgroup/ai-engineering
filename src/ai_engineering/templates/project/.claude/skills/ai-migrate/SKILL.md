...
- `.claude/agents/ai-verify.md` — verify agent for E2E verification of migration testing.
- `.claude/skills/ai-schema/SKILL.md` — database-specific migration safety and rollback procedures.
- `.claude/agents/ai-build.md` — implementation agent for complex database migration decisions.
$ARGUMENTS
