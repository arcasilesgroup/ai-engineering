...
- `.claude/skills/ai-lifecycle/SKILL.md` — skill and agent create lifecycle.
- `.claude/skills/ai-lifecycle/SKILL.md` — skill and agent delete lifecycle.
- `.claude/skills/ai-pr/SKILL.md` — PR creation at spec closure.
$ARGUMENTS
