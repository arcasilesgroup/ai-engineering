...
- `.github/agents/ai-build.agent.md` — implementation agent (debug, refactor, simplify modes).
- `.github/agents/ai-review.agent.md` — review agent (code review, quality).
...
- `.github/prompts/ai-test-plan.prompt.md` — test design.
