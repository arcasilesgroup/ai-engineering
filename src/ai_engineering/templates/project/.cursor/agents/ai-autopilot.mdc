...
> See dispatch threshold in skill body (`.gemini/skills/ai-autopilot/SKILL.md`). The procedural contract for the 6 phases (DECOMPOSE, DEEP PLAN, ORCHESTRATE, IMPLEMENT, QUALITY LOOP, DELIVER) is canonical there; this agent file is the dispatch handle, not a redefinition.
...
| Skill | Phase | Usage |
|-------|-------|-------|
| `.gemini/skills/ai-verify/SKILL.md` | 5 | IRRV protocol, 7 scan modes, platform aggregation |
| `.gemini/skills/ai-review/SKILL.md` | 5 | 8-agent parallel review, self-challenge, corroboration |
| `.gemini/skills/ai-pr/SKILL.md` | 6 | Full PR pipeline (all steps), watch-and-fix loop |
| `.gemini/skills/ai-commit/SKILL.md` | 4, 5 | Wave commits, quality-fix commits |
| `.gemini/skills/ai-build/SKILL.md` | 4 | Task execution patterns, two-stage review (canonical implementation gateway, D-127-11) |
