...
- Skill source of truth: `.cursor/skills/ai-session-watch-sweep/SKILL.md`
- Related: `.cursor/skills/ai-session-watch/SKILL.md`, `.cursor/skills/ai-simplify-sweep/SKILL.md`
