...
READ `.gemini/skills/ai-commit/SKILL.md` and execute steps 0-6 in full. Do NOT skip any step. The documentation gate (step 5) is mandatory.
...
- `.gemini/skills/ai-commit/SKILL.md` -- shared commit pipeline.
- `.gemini/skills/ai-docs/SKILL.md` -- documentation lifecycle (changelog, readme, solution-intent, portal, quality gate).
