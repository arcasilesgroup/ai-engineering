...
2. Read project context: `.ai-engineering/CONSTITUTION.md`, `.ai-engineering/manifest.yml`, and the target artifact (e.g., `.gemini/skills/ai-<skill>/SKILL.md` or `.gemini/agents/ai-<agent>.md`) to understand the improvement surface.
