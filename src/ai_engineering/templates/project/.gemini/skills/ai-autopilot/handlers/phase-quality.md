...
- `.gemini/skills/ai-verify/SKILL.md` -- IRRV protocol, 7 scan modes,
  scan output contract
- `.gemini/skills/ai-review/SKILL.md` -- 8-agent parallel review,
  self-challenge protocol, confidence scoring
- `.gemini/skills/ai-governance/SKILL.md` -- advise mode,
...
1. **Skill files**: `.gemini/skills/ai-verify/SKILL.md`,
