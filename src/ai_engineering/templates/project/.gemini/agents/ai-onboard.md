...
> See dispatch threshold in skill body (`.gemini/skills/ai-onboard/SKILL.md`). Mode procedures (`tour`, `find`, `history`, `onboard`) and pedagogical principles are canonical there. This agent file owns context-loading and read-only boundary enforcement.
...
- `.gemini/skills/ai-onboard/SKILL.md` -- interactive guidance procedures
- `.gemini/skills/ai-explain/SKILL.md` -- 3-tier depth model for explanations
