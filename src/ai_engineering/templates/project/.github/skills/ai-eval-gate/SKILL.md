...
```bash
$CLAUDE_PROJECT_DIR/.github/skills/ai-eval-gate/run.sh check
$CLAUDE_PROJECT_DIR/.github/skills/ai-eval-gate/run.sh report
$CLAUDE_PROJECT_DIR/.github/skills/ai-eval-gate/run.sh enforce
$CLAUDE_PROJECT_DIR/.github/skills/ai-eval-gate/run.sh enforce --skip --reason "scenarios pending"
```
...
- Skill source of truth: `.github/skills/ai-eval-gate/SKILL.md`
