...
Read `.github/skills/ai-simplify/SKILL.md` (when present) to confirm whether an `--auto` flag exists. Otherwise invoke with conservative defaults:
...
- Related: `.github/skills/ai-simplify/SKILL.md`
