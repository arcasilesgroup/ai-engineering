...
Called by: `/ai-schedule` (weekly cron) or operator manually. Calls: `/ai-simplify` (conservative mode), `/ai-commit`, `/ai-pr --draft`. See also: `/ai-repo-tidy` (lifecycle sweep), `/ai-skill-improve` (skill-level improvement).
...
- Skill source of truth: `.github/skills/ai-simplify-sweep/SKILL.md`
