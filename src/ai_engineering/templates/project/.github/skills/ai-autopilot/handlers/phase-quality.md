...
- `.github/skills/ai-governance/SKILL.md` -- advise mode, decision-store lifecycle
...
1. **Skill files**: `.github/skills/ai-verify/SKILL.md`, `.github/skills/ai-review/SKILL.md`, `.github/skills/ai-governance/SKILL.md`
