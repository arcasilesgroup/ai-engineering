...
2. Read project context: `.ai-engineering/CONSTITUTION.md`, `.ai-engineering/manifest.yml`, and the target artifact (e.g., `.github/skills/ai-<skill>/SKILL.md` or `.github/agents/<agent>.agent.md`) to understand the improvement surface.
