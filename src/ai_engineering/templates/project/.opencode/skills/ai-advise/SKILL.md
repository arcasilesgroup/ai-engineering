...
3. **Dependency preflight** — verify `.codex/agents/ai-guard.md` (or, post-rename, `.codex/agents/ai-advise.md`) is on disk. STOP and report the exact missing path if absent — never paraphrase agent instructions inline.
...
- Agent contract: `.codex/agents/ai-guard.md` (or post-rename `.codex/agents/ai-advise.md`)
