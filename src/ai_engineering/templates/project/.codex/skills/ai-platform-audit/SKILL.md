...
**Skill Compatibility**:
- Count directories in `.codex/skills/`, `.github/skills/`, `.codex/skills/`, `.gemini/skills/`
- Scan all `.codex/skills/*/SKILL.md` frontmatter for `copilot_compatible: false`
- Read `skills.total` from `.ai-engineering/manifest.yml`
- Expected: `.github/skills/` count = `.codex/skills/` count − (number of `copilot_compatible: false` skills)

**Agent Distribution**:
- Count files in `.codex/agents/`, `.github/agents/`, `.codex/agents/`, `.gemini/agents/`
