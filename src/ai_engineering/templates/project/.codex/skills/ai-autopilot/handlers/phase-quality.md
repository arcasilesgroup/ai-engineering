...
- `.codex/skills/ai-verify/SKILL.md` -- IRRV protocol, 7 scan modes,
  scan output contract
- `.codex/skills/ai-review/SKILL.md` -- 8-agent parallel review,
  self-challenge protocol, confidence scoring
- `.codex/skills/ai-governance/SKILL.md` -- advise mode,
...
1. **Skill files**: `.codex/skills/ai-verify/SKILL.md`,
