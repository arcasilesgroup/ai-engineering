...
Dispatch threshold and the mode procedures (`tour`, `find`, `history`, `onboard`) are canonical in `.github/skills/ai-onboard/SKILL.md`. This agent file owns context-loading and read-only boundary enforcement.
