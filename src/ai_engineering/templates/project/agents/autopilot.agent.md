...
> See dispatch threshold in skill body (`.github/skills/ai-autopilot/SKILL.md`). The procedural contract for the 6 phases (DECOMPOSE, DEEP PLAN, ORCHESTRATE, IMPLEMENT, QUALITY LOOP, DELIVER) is canonical there; this agent file is the dispatch handle, not a redefinition.
...
| `.github/skills/ai-build/SKILL.md` | 4 | Task execution patterns, two-stage review (canonical implementation gateway, D-127-11) |
