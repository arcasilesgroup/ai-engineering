...
> See dispatch threshold in skill body (`.github/skills/ai-guide/SKILL.md`). Mode procedures (`tour`, `find`, `history`, `onboard`) and pedagogical principles are canonical there. This agent file owns context-loading and read-only boundary enforcement.
