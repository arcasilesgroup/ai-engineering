...
- `.agents/skills/guide/SKILL.md` -- interactive guidance procedures
- `.agents/skills/explain/SKILL.md` -- 3-tier depth model for explanations
- `.agents/skills/explore/SKILL.md` -- codebase exploration (dispatched, not executed)
