...
Uses `.agents/skills/onboard/SKILL.md` for structured codebase onboarding and `.agents/skills/explain/SKILL.md` (shared) for the 3-tier depth model (Quick/Standard/Deep) when delivering explanations. Teaching, architecture tours, and decision archaeology are embedded in this agent definition.
...
Deliver deep explanation of a concept, pattern, or architectural decision using the 3-tier depth model from `.agents/skills/explain/SKILL.md`.
...
Structured codebase onboarding via `.agents/skills/onboard/SKILL.md`.
...
- `.agents/skills/onboard/SKILL.md` -- structured codebase onboarding
- `.agents/skills/explain/SKILL.md` -- shared: 3-tier depth model, explanation delivery, diagram rules
