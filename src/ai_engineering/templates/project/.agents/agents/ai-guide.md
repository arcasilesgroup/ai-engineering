...
Uses `.agents/skills/explain/SKILL.md` (shared) for the 3-tier depth model (Quick/Standard/Deep) when delivering explanations. Teaching, architecture tours, decision archaeology, and structured codebase onboarding are embedded in this agent definition.
