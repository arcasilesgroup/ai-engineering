...
- `.agents/skills/security/SKILL.md` -- OWASP SAST + DAST + deps + SBOM
- `.agents/skills/quality/SKILL.md` -- coverage + complexity + duplication + review
- `.agents/skills/governance/SKILL.md` -- integrity + compliance + ownership
- `.agents/skills/performance/SKILL.md` -- performance profiling and bottleneck detection
- `.agents/skills/accessibility/SKILL.md` -- WCAG 2.1 AA compliance audit
- `.agents/skills/gap/SKILL.md` -- spec vs code gap detection
- `.agents/skills/architecture/SKILL.md` -- drift, coupling, cohesion, boundaries
- `.agents/skills/triage/SKILL.md` -- create work items for findings
