...
| 9 | "This doesn't need a spec" | Every pipeline requires a spec, even trivial | Use `/ai-spec` |
...
| 12 | "This refactor is obvious" | Obvious refactors still need test verification | Use `/ai-refactor` |
...
|-------------------|----------------|
| "implement", "build", "add feature" | `/ai-plan` then `/ai-code` |
| "fix", "bug", "broken", "not working" | `/ai-debug` |
| "test", "coverage", "verify" | `/ai-test` |
| "refactor", "restructure", "move" | `/ai-refactor` |
