...
- Skill source of truth: `.agents/skills/ai-session-watch-sweep/SKILL.md`
- Related: `.agents/skills/ai-session-watch/SKILL.md`, `.agents/skills/ai-simplify-sweep/SKILL.md`
