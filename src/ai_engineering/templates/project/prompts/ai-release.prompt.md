...
- `.github/prompts/ai-governance.prompt.md` — compliance, ownership, integrity gates.
- `.github/prompts/ai-quality.prompt.md` — code quality gate.
- `.github/prompts/ai-test.prompt.md` — test confidence gate.
- `.github/prompts/ai-document.prompt.md` — documentation coherence gate.
- `.github/prompts/ai-security.prompt.md` — security enforcement gate.
- `.github/agents/operate.agent.md` — orchestrator that uses this skill and command reliability source.
