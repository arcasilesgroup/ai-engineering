...
> **Telemetry** (cross-IDE): run `ai-eng signals emit skill_invoked --actor=ai --detail='{"skill":"accessibility"}'` at skill start. Fail-open — skip if ai-eng unavailable.
...
- `.github/agents/build.agent.md` — agent for holistic frontend review.
