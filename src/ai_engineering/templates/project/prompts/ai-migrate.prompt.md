...
- `.github/agents/verify.agent.md` — verify agent for E2E verification of migration testing.
- `.github/prompts/ai-schema.prompt.md` — database-specific migration safety and rollback procedures.
- `.github/agents/build.agent.md` — implementation agent for complex database migration decisions.
