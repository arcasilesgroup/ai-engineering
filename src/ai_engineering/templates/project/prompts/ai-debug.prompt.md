...
- `.github/agents/build.agent.md` — agent that uses this skill systematically.
- `.github/agents/verify.agent.md` — agent that uses debug for investigating verification failures.
- `.github/prompts/ai-explain.prompt.md` — Feynman-style explanations for root cause understanding.
