...
- `.github/agents/verify.agent.md` -- agent that invokes this skill.
- `.github/prompts/ai-security.prompt.md` -- security scanning (separate concern).
- `.github/prompts/ai-test.prompt.md` -- test execution (quality reports gaps, test fills them).
- `.github/prompts/ai-refactor.prompt.md` -- code improvement (quality diagnoses, refactor treats).
