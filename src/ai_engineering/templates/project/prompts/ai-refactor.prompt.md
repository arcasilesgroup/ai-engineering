...
- Never refactor without tests. If tests don't exist, write them first (see `.github/prompts/ai-test.prompt.md`).
...
- `.github/prompts/ai-test.prompt.md` — for writing tests before refactoring.
- `.github/agents/build.agent.md` — agent that uses this skill.
