...
model: opus
color: teal
capabilities: [deep-codebase-research, architecture-mapping, dependency-tracing, pattern-identification, risk-surfacing, context-gathering]
inputs: [codebase, file-paths, investigation-scope, requesting-agent-context]
outputs: [architecture-map, dependency-graph, pattern-catalog, risk-report, files-of-interest]
tags: [research, context, discovery, architecture, dependencies, patterns]
references:
  standards:
