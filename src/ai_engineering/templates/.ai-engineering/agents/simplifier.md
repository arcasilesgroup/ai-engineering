...
model: opus
color: lime
capabilities: [guard-clauses, method-extraction, nesting-flattening, dead-code-removal, conditional-simplification, complexity-reduction]
inputs: [source-files, changed-files, complexity-reports, test-suite]
outputs: [simplified-code, simplification-report, complexity-delta]
tags: [simplification, complexity, refactor, clean-code, background]
references:
  skills:
...
- `skills/simplify/SKILL.md` -- detailed simplification patterns and procedures
