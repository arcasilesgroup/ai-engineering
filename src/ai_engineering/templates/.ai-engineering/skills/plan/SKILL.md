...
- `agents/plan.md` — full planning agent (creates specs, produces execution plan; discover mode embedded)
- `skills/governance/SKILL.md` — governance validation including risk acceptance lifecycle
