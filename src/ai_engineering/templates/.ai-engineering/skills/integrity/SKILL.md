...
- `skills/governance/SKILL.md` -- governance validation modes (integrity, compliance, ownership, operational, risk, standards)
- `agents/guard.md` -- proactive governance advisory and drift detection
- `agents/verify.md` -- 7-mode assessment agent
