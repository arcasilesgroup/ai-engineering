...
name: document
version: 2.0.0
description: 'Documentation authoring with modes: generate (create/update docs), simplify
  (reduce verbosity preserving accuracy), and changelog (generate changelogs and release
  notes).'
