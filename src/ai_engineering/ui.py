...
def verdict(number: int, state: str, title: str, detail: str = "") -> None:
    """One of doctor's twenty-six lines. The state carries the colour, so the failures in a run
...
def summary(title: str, rows: list[tuple[str, str]], style: str) -> None:
    ...
    as more of the table — a person who had just run twenty-six checks could not say
