...
program
  ...
  .option(
    "-s, --stack <stacks...>",
    "Technology stacks (typescript-react, dotnet, python, cicd)",
  )
...
program
  .command("compile")
  .description("Recompile standards and regenerate IDE files")
  .option("-v, --verbose", "Verbose output")
...
program
  ...
  .option(
    "--ci",
    "CI mode — create update branch instead of modifying in place",
  )
