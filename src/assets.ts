...
// .ts/.tsx upstream files are data (evals/fixtures) materialized at dev time; .json ride in the npm package.
...
import askills_ai_brainstorm_handshake_SKILL_md from "../skills/ai-brainstorm/handshake-SKILL.md" with { type: "file" };
import askills_ai_debug_SKILL_md from "../skills/ai-debug/SKILL.md" with { type: "file" };
import askills_ai_debug_ai_debug_SKILL_md from "../skills/ai-debug/ai-debug-SKILL.md" with { type: "file" };
import askills_ai_debug_corpus_md from "../skills/ai-debug/corpus.md" with { type: "file" };
...
import askills_ai_goal_agents_adversary_md from "../skills/ai-goal/agents/adversary.md" with { type: "file" };
...
import askills_ai_issue_report_ai_report_SKILL_md from "../skills/ai-issue-report/ai-report-SKILL.md" with { type: "file" };
import askills_ai_issue_report_corpus_md from "../skills/ai-issue-report/corpus.md" with { type: "file" };
import askills_ai_issue_report_references_documentation_writer_md from "../skills/ai-issue-report/references/documentation-writer.md" with { type: "file" };
import askills_ai_note_SKILL_md from "../skills/ai-note/SKILL.md" with { type: "file" };
import askills_ai_note_ai_note_SKILL_md from "../skills/ai-note/ai-note-SKILL.md" with { type: "file" };
import askills_ai_note_corpus_md from "../skills/ai-note/corpus.md" with { type: "file" };
...
import askills_ai_read_docs_read_the_damn_docs_SKILL_md from "../skills/ai-read-docs/read-the-damn-docs-SKILL.md" with { type: "file" };
import askills_ai_research_SKILL_md from "../skills/ai-research/SKILL.md" with { type: "file" };
import askills_ai_research_ai_research_SKILL_md from "../skills/ai-research/ai-research-SKILL.md" with { type: "file" };
import askills_ai_research_corpus_md from "../skills/ai-research/corpus.md" with { type: "file" };
...
import askills_ai_rtk_rtk_SKILL_md from "../skills/ai-rtk/rtk-SKILL.md" with { type: "file" };
import askills_ai_security_AI_AND_LLM_md from "../skills/ai-security/AI-AND-LLM.md" with { type: "file" };
import askills_ai_security_ATTACK_CLASSES_md from "../skills/ai-security/ATTACK-CLASSES.md" with { type: "file" };
import askills_ai_security_CLIENT_SIDE_md from "../skills/ai-security/CLIENT-SIDE.md" with { type: "file" };
import askills_ai_security_HUNTING_md from "../skills/ai-security/HUNTING.md" with { type: "file" };
import askills_ai_security_MEMORY_SAFETY_AND_BINARY_md from "../skills/ai-security/MEMORY-SAFETY-AND-BINARY.md" with { type: "file" };
import askills_ai_security_RECONNAISSANCE_md from "../skills/ai-security/RECONNAISSANCE.md" with { type: "file" };
import askills_ai_security_SKILL_md from "../skills/ai-security/SKILL.md" with { type: "file" };
import askills_ai_security_VALIDATION_AND_REPORTING_md from "../skills/ai-security/VALIDATION-AND-REPORTING.md" with { type: "file" };
import askills_ai_security_WEB_PROTOCOL_AND_AUTH_md from "../skills/ai-security/WEB-PROTOCOL-AND-AUTH.md" with { type: "file" };
import askills_ai_security_cloudflare_security_audit_SKILL_md from "../skills/ai-security/cloudflare-security-audit-SKILL.md" with { type: "file" };
import askills_ai_security_validate_findings_cjs from "../skills/ai-security/validate-findings.cjs" with { type: "file" };
...
export const EMBEDDED: Record<string, string> = {
  ...
  "../skills/ai-brainstorm/handshake-SKILL.md": askills_ai_brainstorm_handshake_SKILL_md,
  "../skills/ai-debug/SKILL.md": askills_ai_debug_SKILL_md,
  "../skills/ai-debug/ai-debug-SKILL.md": askills_ai_debug_ai_debug_SKILL_md,
  "../skills/ai-debug/corpus.md": askills_ai_debug_corpus_md,
  ...
  "../skills/ai-goal/agents/adversary.md": askills_ai_goal_agents_adversary_md,
  ...
  "../skills/ai-issue-report/ai-report-SKILL.md": askills_ai_issue_report_ai_report_SKILL_md,
  "../skills/ai-issue-report/corpus.md": askills_ai_issue_report_corpus_md,
  "../skills/ai-issue-report/references/documentation-writer.md": askills_ai_issue_report_references_documentation_writer_md,
  "../skills/ai-note/SKILL.md": askills_ai_note_SKILL_md,
  "../skills/ai-note/ai-note-SKILL.md": askills_ai_note_ai_note_SKILL_md,
  "../skills/ai-note/corpus.md": askills_ai_note_corpus_md,
  ...
  "../skills/ai-read-docs/read-the-damn-docs-SKILL.md": askills_ai_read_docs_read_the_damn_docs_SKILL_md,
  "../skills/ai-research/SKILL.md": askills_ai_research_SKILL_md,
  "../skills/ai-research/ai-research-SKILL.md": askills_ai_research_ai_research_SKILL_md,
  "../skills/ai-research/corpus.md": askills_ai_research_corpus_md,
  "../skills/ai-rtk/SKILL.md": askills_ai_rtk_SKILL_md,
  "../skills/ai-rtk/references/commands.md": askills_ai_rtk_references_commands_md,
  "../skills/ai-rtk/rtk-SKILL.md": askills_ai_rtk_rtk_SKILL_md,
  "../skills/ai-security/AI-AND-LLM.md": askills_ai_security_AI_AND_LLM_md,
  "../skills/ai-security/ATTACK-CLASSES.md": askills_ai_security_ATTACK_CLASSES_md,
  "../skills/ai-security/CLIENT-SIDE.md": askills_ai_security_CLIENT_SIDE_md,
  "../skills/ai-security/HUNTING.md": askills_ai_security_HUNTING_md,
  "../skills/ai-security/MEMORY-SAFETY-AND-BINARY.md": askills_ai_security_MEMORY_SAFETY_AND_BINARY_md,
  "../skills/ai-security/RECONNAISSANCE.md": askills_ai_security_RECONNAISSANCE_md,
  "../skills/ai-security/SKILL.md": askills_ai_security_SKILL_md,
  "../skills/ai-security/VALIDATION-AND-REPORTING.md": askills_ai_security_VALIDATION_AND_REPORTING_md,
  "../skills/ai-security/WEB-PROTOCOL-AND-AUTH.md": askills_ai_security_WEB_PROTOCOL_AND_AUTH_md,
  "../skills/ai-security/cloudflare-security-audit-SKILL.md": askills_ai_security_cloudflare_security_audit_SKILL_md,
  "../skills/ai-security/validate-findings.cjs": askills_ai_security_validate_findings_cjs,
