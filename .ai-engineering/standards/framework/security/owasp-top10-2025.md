...
- **Skills**: `skills/review/security/SKILL.md` (step 3 — authentication and authorization).
...
- **Skills**: `skills/review/security/SKILL.md` (step 1 — secret detection, step 5 — config security).
...
- **Skills**: `skills/review/security/SKILL.md` (step 2 — injection analysis).
...
- **Skills**: `skills/review/architecture/SKILL.md`, `agents/architect.md`.
...
- **Skills**: `skills/review/security/SKILL.md` (step 5 — configuration security).
...
- **Skills**: `skills/review/security/SKILL.md` (step 4 — dependency vulnerabilities), `skills/dev/deps-update/SKILL.md`.
...
- **Skills**: `skills/review/security/SKILL.md` (step 3 — authentication).
...
- **Skills**: `skills/review/security/SKILL.md` (step 2 — injection analysis covers SSRF vectors).
