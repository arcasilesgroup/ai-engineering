...
Normative shared rules are defined in `skills/document/SKILL.md` under **Shared Rules (Canonical)** (`DOC-R1..DOC-R4`, `DOC-B1`). The agent references those rules instead of redefining them.
...
1. **Apply shared documentation rules** -- execute `DOC-R1..DOC-R4` from `skills/document/SKILL.md`.
...
- `skills/document/SKILL.md` -- documentation authoring with generate/simplify modes
