...
next_session: "Phase 5+6 — contracts, IDE adapters, mirror, validation"
---
...
- [x] T-012: Update `agents/execute.md` — dispatch + guard skills
...
- [ ] T-017: Reassign `skills/explain/SKILL.md` ownership to guide
- [ ] T-018: Update guide agent to reference explain skill
...
- [x] T-044: Update audit.py telemetry actor names
- [x] T-045: Update governance_cmd.py skill_names list (40 skills)
- [x] T-046: Update sync_command_mirrors.py AGENT_DESCRIPTIONS
...
- [ ] T-050: Rename .claude/commands/ai/*.md per skill renames
- [ ] T-051: Rename .github/prompts/ai-*.prompt.md per skill renames
- [ ] T-052: Rename .github/agents/*.agent.md per agent renames

## Phase 4: Standards [M]
- [x] T-053: DESCOPED — standards/framework/ flatten deferred (too many refs to update for low benefit)
- [x] T-054: Create standards/framework/governance/agent-model.md
...
- [ ] T-061: Rewrite framework-contract.md (10 agents, dispatch, guard, evolve)
- [ ] T-062: Rewrite product-contract.md (v0.3.0, 10 agents, 40 skills)
- [x] T-063: Create .ai-engineering/README.md
- [ ] T-064: Rewrite GOVERNANCE_SOURCE.md
- [ ] T-065: Regenerate IDE adapters from GOVERNANCE_SOURCE
- [x] T-066: PARTIAL — root README needs architecture section update
...
- [ ] T-069: Sync to src/ai_engineering/templates/.ai-engineering/
- [ ] T-070: Run full test suite → 0 failures
- [ ] T-071: Run ai-eng validate
- [ ] T-072: Document gaps in done.md
