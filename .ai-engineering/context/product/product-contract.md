...
1. Complete governance content: 25 skills, 8 agents, 3 stack instructions.
...
Current work tracked in: `specs/_active.md` → `003-governance-enforcement`.
...
| Agent coverage (skills + agents defined) | 25 skills + 8 agents | 0/25 skills, 0/8 agents |
