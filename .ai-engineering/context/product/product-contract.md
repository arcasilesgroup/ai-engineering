...
1. Complete governance content: 29 skills, 8 agents, 3 stack instructions.
...
Current work tracked in: `specs/_active.md` → `004-hygiene-risk-governance`.

Read sequence:
1. `specs/003-governance-enforcement/spec.md` — problem, solution, scope
2. `specs/003-governance-enforcement/plan.md` — architecture, patterns, session map
3. `specs/003-governance-enforcement/tasks.md` — ordered phases, checkboxes
...
| Agent coverage (skills + agents defined) | 29 skills + 8 agents | 0/29 skills, 0/8 agents |
