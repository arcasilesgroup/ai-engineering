...
status: part-a-shipped
effort: large
superseded_by: spec-149 (Part B / D-148-11..17 re-scoped under YAGNI)
note: "Part A (files-only persistence, D-148-01..10) SHIPPED on PR #532. Part B (obvious-by-default conventions, D-148-11..17) was never executed and is superseded by spec-149 (trimmed). Archived snapshot of the active spec.md as of spec-149 creation."
