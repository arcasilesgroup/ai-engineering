# CONSTITUTION.md — Pre-Migration Rotation (2026-05-11)

> **Purpose**: spec-131 D-131-04 rescoped CONSTITUTION.md to
> project-identity-only and migrated all AI-behaviour content into
> CANONICAL.md (and its byte-equivalent mirrors). This file is the
> verbatim pre-migration body, preserved for traceability per
> R-131-03 / R-1.2 mitigation.
>
> **Migration date**: 2026-05-11.
> **Spec**: spec-131 (DX Excellence Refactor — Trimmed).
> **Decision**: D-131-04 (CONSTITUTION pivots to project-identity).
> **AI-behaviour destination**: CANONICAL.md §§1-13 + the four mirrors.
>
> Operator-authored prohibitions and compliance gates from the
> previous Article XII are preserved verbatim under the new
> CONSTITUTION.md `## Prohibitions` + `## Compliance gates` sections;
> nothing was discarded, only re-categorised.
...
<!--
ADAPTATION NOTE (preserved from pre-migration body)
