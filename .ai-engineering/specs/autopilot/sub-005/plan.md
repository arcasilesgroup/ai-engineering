...
- [ ] T-5.1: Delete ai-engineering-specific template files from contexts/team/
...
- [ ] T-5.2: Make lessons.md template generic (remove ai-engineering specific patterns)
...
- [ ] T-5.3: Create specs/ placeholder templates
...
- [ ] T-5.4: Fix GovernancePhase._classify to deploy team seed files on INSTALL and FRESH modes
...
- [ ] T-5.5: Write unit tests for team seed deployment and specs directory creation
...
- [ ] T-5.6: Update e2e test for team seed content and specs directory
...
- [ ] T-5.7: Verify all tests pass (unit + e2e + integration)
