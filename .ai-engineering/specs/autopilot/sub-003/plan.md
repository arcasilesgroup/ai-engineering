...
- [ ] T-1.1: Delete template contract files and product/ directory
  **Files**:
...
- [ ] T-2.1: Create project-identity.md template
  **Files**:
...
- [ ] T-2.2: Create project-identity.md dogfood
  **Files**:
...
- [ ] T-3.1: Create ai-project-identity SKILL.md for Claude Code
  **Files**:
...
- [ ] T-3.2: Create ai-project-identity mirrors for GitHub Copilot and Codex/Gemini
  **Files**:
...
- [ ] T-3.3: Create ai-project-identity template mirrors
  **Files**:
...
- [ ] T-4.1: Update CLAUDE.md (repo root) -- counts, skill list, effort table, loading instruction
  **Files**:
  - EDIT `CLAUDE.md`
  **Changes**:
...
- [ ] T-4.2: Update template CLAUDE.md -- same changes as T-4.1
  **Files**:
...
- [ ] T-4.3: Update AGENTS.md (repo root) -- counts and skill list
  **Files**:
  - EDIT `AGENTS.md`
  **Changes**:
...
- [ ] T-4.4: Update template AGENTS.md -- same changes as T-4.3
  **Files**:
  - EDIT `src/ai_engineering/templates/project/AGENTS.md`
  **Done**: Content mirrors repo root AGENTS.md after edits.

- [ ] T-4.5: Update .github/copilot-instructions.md -- count and loading instruction
  **Files**:
...
- [ ] T-4.6: Update template copilot-instructions.md -- count, loading, remove framework-contract ref, fix path
  **Files**:
...
- [ ] T-4.7: Update both manifest.yml files -- total, registry, comment
  **Files**:
...
- [ ] T-4.8: Update ai-brainstorm SKILL.md -- add project-identity to context loading
  **Files**:
...
- [ ] T-4.9: Update ai-brainstorm/handlers/interrogate.md -- add identity as explore context
  **Files**:
...
- [ ] T-4.10: Update ai-plan SKILL.md -- add project-identity to context loading
  **Files**:
...
- [ ] T-4.11: Update ai-governance SKILL.md -- replace framework-contract reference in all 4 mirrors
  **Files**:
...
- [ ] T-5.1: Update defaults.py -- replace product/** ownership with project-identity.md
  **Files**:
...
- [ ] T-5.2: Migrate _extract_listings and helpers from instruction_consistency.py to _shared.py
  **Files**:
...
- [ ] T-5.3: Migrate pointer-count validation from instruction_consistency.py into counter_accuracy.py
  **Files**:
...
- [ ] T-5.4: Delete instruction_consistency.py
  **Files**:
  - DELETE `src/ai_engineering/validator/categories/instruction_consistency.py`
  **Done**: File does not exist.

- [ ] T-5.5: Update categories/__init__.py -- remove instruction_consistency
  **Files**:
...
- [ ] T-5.6: Update service.py -- remove INSTRUCTION_CONSISTENCY from checkers
  **Files**:
...
- [ ] T-5.7: Update _shared.py -- remove dead constants and enum value
  **Files**:
  - EDIT `src/ai_engineering/validator/_shared.py`
  **Changes**:
...
- [ ] T-6.1: Update test_state.py -- replace product test with project-identity test
  **Files**:
...
- [ ] T-6.2: Update test_validator.py -- remove product-contract fixtures, update setup
  **Files**:
...
- [ ] T-6.3: Update test_gap_fillers4.py -- remove product-contract fixtures
  **Files**:
...
- [ ] T-6.4: Update test_install_clean.py -- replace contexts/product with project-identity.md
  **Files**:
...
- [ ] T-6.5: Run full test suite to verify no regressions
