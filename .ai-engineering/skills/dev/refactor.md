...
- Never refactor without tests. If tests don't exist, write them first (see `skills/dev/test-strategy.md`).
...
- `skills/dev/test-strategy.md` — for writing tests before refactoring.
