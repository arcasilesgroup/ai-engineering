...
- `skills/lifecycle/create-skill.md` — registration procedure for new skills.
- `skills/lifecycle/create-agent.md` — registration procedure for new agents.
- `skills/swe/prompt-engineer.md` — content authoring quality.
- `skills/swe/pr-creation.md` — PR creation at spec closure.
