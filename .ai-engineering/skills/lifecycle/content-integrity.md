...
- Command: agent invokes content-integrity skill after modifying governance content.
...
- `skills/lifecycle/create-skill.md` — skill registration procedure (validates creation correctness).
- `skills/lifecycle/create-agent.md` — agent registration procedure (validates creation correctness).
- `skills/lifecycle/delete-skill.md` — skill removal procedure (validates deletion completeness).
- `skills/lifecycle/delete-agent.md` — agent removal procedure (validates deletion completeness).
- `skills/lifecycle/create-spec.md` — spec creation procedure (validates spec structure).
