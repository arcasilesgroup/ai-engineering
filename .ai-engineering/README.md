...
- Non-state governance files must stay identical between both locations, except high-churn project execution logs (`context/backlog/tasks.md`, `context/delivery/implementation.md`, and `context/delivery/evidence/**`) which are canonical-only runtime artifacts.
