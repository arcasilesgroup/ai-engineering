...
### Skills — 47 in flat organization
...
Activate any agent with `/ai:<name>` — for example, `/ai:review` for code review or `/ai:scan` for architecture drift detection.
