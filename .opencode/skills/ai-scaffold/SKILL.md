...
- [ ] File at correct path (`.codex/skills/ai-<name>/SKILL.md` or `.codex/agents/ai-<name>.md`)
...
Format reference: .codex/skills/ai-security/SKILL.md or .codex/skills/ai-review/SKILL.md
```
